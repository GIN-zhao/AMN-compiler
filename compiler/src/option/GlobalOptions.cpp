...
EnumOpt spnc::option::compilationTarget{
    "target", {EnumVal(CPU, "CPU"), EnumVal(CUDA, "CUDA")}, {required()}};
...
Option<unsigned> spnc::option::slpMaxAttempts{
    "slp-max-attempts", 1, {depends(spnc::option::cpuVectorize, true)}};
...
Option<unsigned> spnc::option::slpMaxNodeSize{
    "slp-max-node-size", 10, {depends(spnc::option::cpuVectorize, true)}};

Option<unsigned> spnc::option::slpMaxLookAhead{
    "slp-max-look-ahead", 3, {depends(spnc::option::cpuVectorize, true)}};

Option<bool> spnc::option::slpReorderInstructionsDFS{
    "slp-reorder-dfs", true, {depends(spnc::option::cpuVectorize, true)}};
...
Option<bool> spnc::option::slpUseXorChains{
    "slp-use-xor-chains", false, {depends(spnc::option::cpuVectorize, true)}};
