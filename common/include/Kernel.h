...
///
/// Represents a kernel that is generated by the compiler and can be loaded and
/// executed by the runtime. Contains information about the file-path of the
/// generated kernel and the name of the generated function inside that file.
///
class Kernel {
...
public:
  ...
  Kernel(const std::string &fN, const std::string &kN, unsigned query_type,
         unsigned target, unsigned _batchSize, unsigned _numFeatures,
         unsigned _bytesPerFeatures, unsigned numResults,
         unsigned bytesPerResult, const std::string &dataType)
      : _fileName{fN}, _kernelName{kN}, query{query_type}, targetArch{target},
        batch_size{_batchSize}, num_features{_numFeatures},
        bytes_per_feature{_bytesPerFeatures}, num_results{numResults},
        bytes_per_result{bytesPerResult}, dtype{dataType} {
